"""Session create/patch service behavior shared by gateway adapters."""
...
def agent_registry_model(ctx: Any, agent_id: str) -> str | None:
...
async def agent_registry_has(ctx: Any, agent_id: str) -> bool:
    """Return whether *agent_id* exists, failing open without registry support."""
...
def session_turn_model(ctx: Any, session: Any | None, agent_id: str) -> str | None:
...
async def create_session(params: dict | None, ctx: Any) -> dict:
...
async def patch_session(params: dict | None, ctx: Any) -> dict:
