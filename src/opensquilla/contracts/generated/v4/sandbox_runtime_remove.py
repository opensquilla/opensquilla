...
#   filename:  sandbox-runtime-remove.schema.json
...
class RequestFrame(BaseModel):
    ...
    type: Literal['req']
    id: StrictStr
    method: Literal['sandbox.runtime.remove']
    params: Params
...
class ResponseFrame(BaseModel):
    ...
    type: Literal['res']
    id: StrictStr
    method: Literal['sandbox.runtime.remove'] | None = None
    ok: StrictBool
    payload: Result | None = None
    error: RpcError | None = None


class OpensquillaSandboxRuntimeRemoveContract(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
