...
class CronRouteEnvelope:
    ...
    def delivery_fields(self) -> dict[str, Any]:
        ...
        return runtime_routing.delivery_fields_from_route(self)
    ...
    *,
    ...
    ctx = ToolContext(
        ...
        interaction_mode=InteractionMode(
            runtime_routing.interaction_mode_value(envelope.interaction_mode)
        ),
        ...
        source_kind=runtime_routing.source_kind_value(envelope.source_kind),
