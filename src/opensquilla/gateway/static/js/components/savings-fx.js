/** OpenSquilla — Savings FX: viewport-centered particle burst for squilla-router & prompt-cache signals. */
...
const SavingsFX = (() => {
  ...
  // non-top-tier squilla-router routed savings turns with the same model/tier
