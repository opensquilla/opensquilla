...
#   filename:  sandbox-runtime-install.schema.json
...
class RequestFrame(BaseModel):
    ...
    type: Literal['req']
    id: StrictStr
    method: Literal['sandbox.runtime.install']
    params: Params
...
class ResponseFrame(BaseModel):
    ...
    type: Literal['res']
    id: StrictStr
    method: Literal['sandbox.runtime.install'] | None = None
    ok: StrictBool
    payload: Result | None = None
    error: RpcError | None = None


class OpensquillaSandboxRuntimeInstallContract(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
