...
#   filename:  artifacts-prompt-annotations-list.schema.json
...
class Params(BaseModel):
    ...
    limit: _JsonInteger | None = Field(None, ge=1, le=500)
...
class Request(BaseModel):
    ...
    type: Literal['req']
    id: StrictStr
    method: Literal['artifacts.prompt_annotations.list']
    params: Params
...
class OpensquillaArtifactsPromptAnnotationsListContract(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
