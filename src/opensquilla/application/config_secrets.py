...
Read-side redaction and write-side restoration share this policy. The
Gateway model and application settings owner both use this module.
"""
...
REDACTED_PUBLIC_VALUE = _REDACTED
...
def restore_redacted_values(payload: Any, source: Any, prefix: str = "") -> tuple[Any, set[str]]:
...
def inherit_then_clear_explicit(source: Any, target: Any, explicit_secret_paths: set[str]) -> None:
