...
# scope to make audits easy. Comments mark methods that are OpenSquilla-specific
...
METHOD_SCOPES: dict[str, str] = {
    ...
    "knowledge.collections": READ_SCOPE,
    ...
    "cron.subscribe": READ_SCOPE,  # OpenSquilla-only; classified read.
