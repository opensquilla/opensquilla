...
#   filename:  artifacts-prompt-annotations-discard.schema.json
...
class Request(BaseModel):
    ...
    type: Literal['req']
    id: StrictStr
    method: Literal['artifacts.prompt_annotations.discard']
    params: Params
...
class OpensquillaArtifactsPromptAnnotationsDiscardContract(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
