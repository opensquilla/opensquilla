...
OpenSquilla 0.5.0 Preview 2 が現在のプレビューリリースです。
...
0.5.0 Preview 2 をデスクトップで使う場合は、GitHub リリースからパッケージ版デスクトップインストーラーを使うことをおすすめします。macOS では `OpenSquilla-0.5.0-rc2-mac-arm64.dmg`、Windows では `OpenSquilla-0.5.0-rc2-win-x64.exe` です。
...
0.5.0 Preview 2 のデスクトップインストーラーは、Vue 製コントロールコンソールとゲートウェイランタイムを Electron シェルにまとめています。
