...
from opensquilla.contracts.attachments import (
    IMAGE_ATTACHMENT_BYTES as IMAGE_ATTACHMENT_BYTES,
)
from opensquilla.contracts.attachments import (
    IMAGE_ATTACHMENT_MIMES as IMAGE_ATTACHMENT_MIMES,
)
from opensquilla.contracts.attachments import (
    INLINE_ATTACHMENT_BYTES as INLINE_ATTACHMENT_BYTES,
)
from opensquilla.contracts.attachments import (
    MAX_ATTACHMENT_BYTES as MAX_ATTACHMENT_BYTES,
)
from opensquilla.contracts.attachments import (
    MAX_ATTACHMENTS as MAX_ATTACHMENTS,
)
from opensquilla.contracts.attachments import (
    MAX_STAGED_PDF_BYTES as MAX_STAGED_PDF_BYTES,
)
from opensquilla.contracts.attachments import (
    MAX_TOTAL_ATTACHMENT_BYTES as MAX_TOTAL_ATTACHMENT_BYTES,
)
from opensquilla.contracts.attachments import (
    PDF_MAGIC as PDF_MAGIC,
)
from opensquilla.contracts.attachments import (
    SNIFF_PEEK_BYTES as SNIFF_PEEK_BYTES,
)
from opensquilla.contracts.attachments import (
    TEXT_ATTACHMENT_BYTES as TEXT_ATTACHMENT_BYTES,
)
from opensquilla.contracts.attachments import (
    TEXT_ATTACHMENT_MIMES as TEXT_ATTACHMENT_MIMES,
)
from opensquilla.contracts.attachments import (
