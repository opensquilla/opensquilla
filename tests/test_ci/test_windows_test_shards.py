...
RECENTLY_ADDED_ACTIVE_TESTS = {
    ...
    "tests/test_migrations/test_v025_meta_control_intents.py",
    "tests/test_migrations/test_v026_meta_launch_drafts.py",
    "tests/test_migrations/test_v027_meta_launch_discard_tombstones.py",
